...
import supportTr from "./support.tr.json";
import supportEn from "./support.en.json";
import supportAr from "./support.ar.json";

import migrationTr from "./migration.tr.json";
